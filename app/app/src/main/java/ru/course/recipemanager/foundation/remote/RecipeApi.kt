...
interface RecipeApi {
    ...
    @POST("complaints")
    suspend fun createComplaint(@Body request: ComplaintRequest): ComplaintDto

    @GET("admin/complaints")
    suspend fun getComplaints(): List<ComplaintDto>

    @PATCH("admin/complaints/{complaintId}/review")
    suspend fun reviewComplaint(@Path("complaintId") complaintId: Long): ComplaintDto

    @PATCH("admin/complaints/{complaintId}/resolve")
    suspend fun resolveComplaint(@Path("complaintId") complaintId: Long): ComplaintDto
}
