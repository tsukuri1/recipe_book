...
interface RecipeRepository {
    ...
    suspend fun addIngredientsToShoppingList(recipeId: Long, ingredients: List<Ingredient>)
    suspend fun submitComplaint(recipeId: Long, recipeTitle: String, title: String, description: String)
