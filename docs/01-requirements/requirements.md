...
| FR-05 | Пользователь может отправить жалобу на рецепт | Medium |
| FR-06 | Администратор может одобрять рецепты и обрабатывать жалобы | Medium |
| FR-07 | Профиль сохраняет имя и аватар | Medium |
...
### FR-05. Жалоба на рецепт

Пользователь должен иметь возможность отправить жалобу из карточки рецепта, указав причину и описание проблемы. Жалоба передается на backend и появляется в административном контуре для дальнейшей обработки.

### FR-06. Администрирование
