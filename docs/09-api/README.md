...
Swagger UI доступен после Docker-запуска backend: `http://localhost:8082/swagger-ui.html`.
Для Android-эмулятора базовый URL API: `http://10.0.2.2:8082/api`.
...
- `complaints` — отправка жалобы пользователем;
