...
| [04-detailed-design/](04-detailed-design/) | [Диаграммы последовательности](04-detailed-design/sequence-diagrams.md)<br>[Спецификации методов](04-detailed-design/methods-specifications.md)<br>[Диаграмма классов проектирования](04-detailed-design/design-classes-diagram.md) |
...
| [09-api/](09-api/) | [REST endpoints](09-api/openapi-endpoints.md)<br>[OpenAPI](09-api/openapi.yaml)<br>[Postman коллекция](09-api/postman-collection.json)<br>[Проверка API](09-api/api-test.md) |
...
| [13-final-report/](13-final-report/) | [Пояснительная записка](13-final-report/Пояснительная_Записка.docx)<br>[Описание итоговых материалов](13-final-report/README.md) |
...
| 23 | IDEF0 Context Diagram | [23-idef0-context-diagram.png](images/23-idef0-context-diagram.png) |
| 24 | WBS Diagram | [24-wbs-diagram.png](images/24-wbs-diagram.png) |
| 25 | Gantt Diagram | [25-gantt-diagram.png](images/25-gantt-diagram.png) |
...
- [Итоговая пояснительная записка](13-final-report/Пояснительная_Записка.docx)
