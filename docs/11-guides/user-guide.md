...
6. Если в рецепте есть ошибка, отправьте жалобу из карточки рецепта.
7. Отмечайте купленные продукты галочкой.
8. В профиле измените имя и аватар.
...
Если рецепт содержит ошибку, дубликат или некорректное описание, пользователь открывает карточку рецепта и нажимает «Пожаловаться на рецепт». В диалоге нужно указать причину и описание проблемы. После отправки жалоба передается администратору.
